...
<div class="container haft-form">
    <form action="{{ route('admin.blog.update') }}" method="post" enctype="multipart/form-data" id="Msg_Form">
        @csrf
            ...
            <div class="col">
                <div class="row pt-3">
                    ...
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Judul Kegiatan" value="{{ $blog->title }}">
                    </div>
                    <div class="col-1"></div>
                </div>
                <div class="row pt-3">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control" id="videolink" name="video" placeholder="Link Video" value="{{ $blog->video->path }}">
                    </div>
                    <div class="col-1"></div>
                </div>
            </div>
