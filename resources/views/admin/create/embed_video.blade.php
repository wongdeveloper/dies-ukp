...
<div class="container haft-form">
    <form action="{{ route('admin.embed_video.store') }}" method="post" id="Msg_Form">
        @csrf
        <div class="row pt-3 ps-3 haft-form-header">
            <div class="col">
                <h2>Unggah Embed Video</h2>
            </div>
        </div> 
        <div class="row">
            <div class="col">
                <div class="row pt-3">
                    ...
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control" id="title" name="name" placeholder="Judul Kegiatan">
                    </div>
                    <div class="col-1"></div>
                </div>
                <div class="row pt-3">
...
@section('js')
    <script>
        ...
        $(document).on('submit', '#Msg_Form', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.embed_video.store') }}",
                data: formdata,
                async: false,
                cache: false,
                processData: false,
