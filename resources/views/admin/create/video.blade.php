...
<div class="container haft-form">
    <form action="{{ route('admin.ucapan.store') }}" method="post" id="Msg_Form">
        @csrf
        <div class="row pt-3 ps-3 haft-form-header">
            <div class="col">
                <h2>Unggah Video Ucapan Undangan</h2>
            </div>
        </div> 
        <div class="row">
            <div class="col">
                <div class="row pt-3">
                    ...
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control" id="title" name="video_title" placeholder="Judul Kegiatan">
                    </div>
                    <div class="col-1"></div>
                </div>
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-10">
                        ...
                        <input type="text" class="form-control" id="videolink" name="wish" placeholder="Link Video">
                    </div>
                    <div class="col-1"></div>
                </div>
                <div class="row pt-3">
...
@section('js')
    <script>
        ...
        $(document).on('submit', '#Msg_Form', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.ucapan.video.store') }}",
                data: formdata,
                async: false,
                cache: false,
                processData: false,
