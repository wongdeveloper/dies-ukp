...
<div class="ucapan-content">
    ...
    <div class="container-fluid ucapan-foto">
        <div class="row pt-5 title">    
            ...
            <div class="col-3"></div>
            <div class="col-3 haft-btn-pink" data-bs-toggle="modal" data-bs-target="#modal-ucapan-foto">
    ...
    <div class="container-fluid ucapan-teks">
        <div class="row pt-5 title">
            ...
            <div class="col-3 haft-btn-yellow">
                <p class="text-center pt-2" data-bs-toggle="modal" data-bs-target="#modal-ucapan-teks">Unggah Ucapanmu</p>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="row p-0 m-0 pt-3 ps-3 haft-header-modal">
                <div class="col">
                    <h3 style="">Unggah Foto Ucapanmu !</h3>
                </div>
            </div>
            ...
            <div class="row pt-2 pb-5">
                <div class="col text-center">
                    <button class="btn haft-modal-btn submit-ucapan-foto" data-bs-dismiss="modal">
                        <p style="margin: 0; font-size:15pt">Unggah Foto</p>
                    </button>
                </div>
            </div>
          </div>
    ...
    {{-- Modal Ucapan Teks --}}
    <div class="modal fade haft-modal" id="modal-ucapan-teks" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="row p-0 m-0 pt-3 ps-3 haft-header-modal">
                <div class="col">
            ...
            <div class="row pt-2 pb-5">
                <div class="col text-center">
                    <button class="btn haft-modal-btn submit-ucapan-foto" data-bs-dismiss="modal">
                        <p style="margin: 0; font-size:15pt">Unggah Ucapan</p>
                    </button>
                </div>
            </div>
          </div>
