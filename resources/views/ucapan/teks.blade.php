    ...
    <div class="container-fluid ucapan-teks">
        ...
        {{-- BUAT NON HP --}}
            <div class="row pt-5 title d-none d-md-flex">
                ...
                <div class="col-3"></div>
                <div class="col-3 haft-btn-yellow" data-bs-toggle="modal" data-bs-target="#modal-ucapan">
        ...
        {{-- BUAT HP --}}
            ...
            <div class="row ps-2 d-flex d-md-none">
                <div class="col-10 haft-btn-yellow" data-bs-toggle="modal" data-bs-target="#modal-ucapan">
                    <p class="text-center pt-2">Unggah Ucapanmu</p>
                </div>
            </div>
        {{-- ========= --}}
